...
APP_DIR="$PROJECT_DIR/build/$CONFIGURATION/ImaotoBar.app"
...
mkdir -p "$APP_DIR/Contents/Resources/Scripts" "$APP_DIR/Contents/Resources/Assets"

swiftc \
    "${SWIFT_FLAGS[@]}" \
    -vfsoverlay "$PROJECT_DIR/Resources/SwiftToolchainOverlay.yaml" \
    -module-cache-path "$MODULE_CACHE_DIR" \
    -o "$APP_DIR/Contents/MacOS/ImaotoBar" \
    "${SOURCE_FILES[@]}"
